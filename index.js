var runners = [{ id: 1, first_name: "Charmain", last_name: "Seiler", email: "cseiler0@wired.com", shirt_size: "2XL", company_name: "Divanoodle", donation: 75 },
...
function processSum(numberList, callback) {
 const sum = numberList.reduce((total, element) => {
...
function firstNamesAllCaps(runners) {
  /* CODE HERE */
  const capName = runners.map(function(item) {
...
function tallyUpDonations(runners) {
  const tally = runners.reduce((total, runner) => {
